...
<section class="mt-8 bg-white rounded-xl shadow overflow-hidden">
    <div class="p-4 border-b bg-gray-50">
        ...
        <p class="text-sm text-gray-500">Yalnizca olmayan kayitlari ekler, eklenen demo kayitlari temizler. Kaynak dosya: <code>database/demo/demo-data.json</code>. Lokal mevcut veriden kaynak olusturmak icin: <code>php artisan demo:export-current</code></p>
    </div>
